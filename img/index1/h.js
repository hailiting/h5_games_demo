(function () {
  var c = {
    id: "0ae524064813b8dc07ece5ce724a7b04",
    dm: ["9g.com"],
    etrk: [],
    ...
    (function () {
      if (!d)
        if (((d = l), "complete" === document.readyState)) a.b = l;
          ...
          document.addEventListener("DOMContentLoaded", f, n),
  ...
  var O = 0,
    ...
    Q = "httpssssss:" == document.location.protocol ? "httpssssss:" : "http:",
    R =
      "cc cf ci ck cl cm cp cw ds ep et fl ja ln lo lt nv rnd si st su v cv lv api tt u".split(
        " "
      );
  function V() {
        ...
        switch (a[0]) {
          ...
          case "_setCustomVar":
            ...
            if (0 < d && 6 > d && 0 < e && 4 > e) {
              this.c++;
              for (
                var f = (this.a.cv || "*").split("!"), k = f.length;
                k < d - 1;
                k++
              )
                f.push("*");
              ...
              a = this.a.cv
                ...
                .replace(/((^|!)\*)+$/g, "");
              "" !== a
                ? this.setData("Hm_cv_" + c.id, encodeURIComponent(a), c.age)
                : na();
            }
            break;
          case "_trackOrder":
          ...
          case "_trackMobConv":
            if (
              ...
              (this.a.api |= 32), (this.a.et = 93), (this.a.ep = a), W(this);
        }
      }
    },
  };
  function oa() {
    ...
    if (a)
      for (var a = a.split(","), b = 0, d = a.length; b < d; b++)
        B(
          Q + "//" + decodeURIComponent(a[b]).replace(/^https?:\/\//, ""),
          function (a) {
            X(a);
          }
        );
  ...
  function X(a) {
    ...
    b &&
      ((b = b
        .replace(
          RegExp(
            encodeURIComponent(a.replace(/^https?:\/\//, "")).replace(
              /([\*\(\)])/g,
              "\\$1"
            ) + "(%26u%3D[^,]*)?,?",
            "g"
        ...
        : window.sessionStorage &&
          window.sessionStorage.removeItem("Hm_unsent_" + c.id));
  }
  function qa(a, b) {
    var d = x("Hm_unsent_" + c.id) || "",
      e = a.a.u ? "" : "&u=" + encodeURIComponent(document.location.href),
      d =
        encodeURIComponent(b.replace(/^https?:\/\//, "") + e) +
        (d ? "," + d : "");
    w("Hm_unsent_" + c.id, d);
  }
  function W(a) {
  ...
  function ka(a) {
    try {
      ...
      if ((h = a.getData("Hm_lvt_" + c.id))) {
        g = h.split(",");
        for (var D = g.length - 1; 0 <= D; D--)
          13 == g[D].length && (g[D] = "" + Math.round(g[D] / 1e3));
      ...
      if (
        ...
        ("" == document.referrer || Y(document.referrer))
      )
        (b = 0), (d = 4);
      a.a.nv = b;
      a.a.st = d;
      ...
      if (navigator.plugins && navigator.mimeTypes.length) {
        ...
        z &&
          z.description &&
          (b = z.description.replace(/^.*\s+(\S+)\s+\S+$/, "$1"));
      } else if (window.ActiveXObject)
        try {
          var ca = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
          ca &&
            (b = ca.GetVariable("$version")) &&
            (b = b.replace(/^.*\s+(\d+),(\d+).*$/, "$1.$2"));
        } catch (ya) {}
      J.fl = b;
      a.a.v = "1.0.59";
      ...
      if ("" != c.icon) {
        var r,
          s = c.icon.split("|"),
          Shref = "httpssssss://tongji.baidu.com/hm-web/welcome/ico?s=" + c.id,
          T =
            ("http:" == Q ? "httpssssss://eiv" : "httpssssss://bs") +
            ".baidu.com" +
            s[0] +
            "." +
            s[1];
      ...
      var K = document.location.hash.substring(1),
        ua = RegExp(c.id),
        va = -1 < document.referrer.indexOf("baidu.com") ? l : n;
      if (K && ua.test(K) && va) {
      ...
      if (c.rec || c.trust)
        a.a.nv
          ? ((a.g = encodeURIComponent(document.referrer)),
            window.sessionStorage
              ? w("Hm_from_" + c.id, a.g)
              : G("Hm_from_" + c.id, a.g, 864e5))
          : (a.g =
              (window.sessionStorage
                ? x("Hm_from_" + c.id)
                : H("Hm_from_" + c.id)) || "");
        ...
        for (r = 0; r < t.length; r++) {
          ...
          switch (A[0]) {
            case "_setAccount":
              1 < A.length &&
                /^[0-9a-z]{32}$/.test(A[1]) &&
                ((a.a.api |= 1), (window._bdhm_account = A[1]));
              break;
            case "_setAutoPageview":
              if (1 < A.length) {
                var U = A[1];
                if (n === U || l === U)
                  (a.a.api |= 2), (window._bdhm_autoPageview = U);
              }
          }
        }
      if (
        "undefined" === typeof window._bdhm_account ||
      ...
      if (
        "undefined" === typeof window._bdhm_autoPageview ||
        window._bdhm_autoPageview === l
      )
        (a.h = l), (a.a.et = 0), (a.a.ep = ""), W(a);
    } catch (ga) {
      (a = []),
        a.push("si=" + c.id),
        ...
        B(Q + "//hm.baidu.com/hm.gif?" + a.join("&"));
    }
  }
  function ra(a) {
  ...
  function ma() {
    for (var a = 0, b = c.dm.length; a < b; a++) {
      var d = c.dm[a];
      if (-1 < d.indexOf("/") && wa(document.location.href, d))
        return d.replace(/^[^\/]+(\/.*)/, "$1") + "/";
    }
    return "/";
  }
  ...
  function ta() {
    ...
    "object" == typeof document.onfocusin
      ? (I(document, "focusin", $(this)), I(document, "focusout", $(this)))
      : (I(window, "focus", $(this)), I(window, "blur", $(this)));
  }
  function $(a) {
    return function (b) {
