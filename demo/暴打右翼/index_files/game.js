...
Time.prototype.update = function () {
    ...
    }), finalTitleText.setText(shareData.sDesc + "\uff01"), finalTitleText.position.x = (screenWidth - finalTitleText.width) / 2, stage.addChild(finalTitleText), stage.addChild(restartbutton), stage.addChild(fenxiangbutton), GAME.currentScreen = "scoreScreen", console.log("times up!"))
};
...
var shareData = {
    ...
    sImgurl: "http://1251002861.cdn.myqcloud.com/1251002861/jyfy/img/ico_large.png",
    sLink: 'http://1251002861.cdn.myqcloud.com/1251002861/jyfy/index.html',
    sCallback: "http://mp.weixin.qq.com/s?__biz=MzA4NjE1MzAzNg==&mid=200817134&idx=1&sn=29e365760d908c50e2b3af4a55814186#rd"
};
document.addEventListener("WeixinJSBridgeReady",
function () {
    WeixinJSBridge.on("menu:share:appmessage",
    function (a) {
        a = shareData.sDesc.replace(/(\s)+/g, "");
        0 < userScore && (a += "\uff0c\u6c42\u8d85\u8d8a");
