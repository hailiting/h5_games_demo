    ...
    LoadPhotoPage: function () {
        ...
        $.ajax({
            ...
            error: function (XMLHttpRequest, textStatus, errorThrown) {
            	...
            	//@author kevin   临时测试使用
				 var photoList= [
			            { "photoId": "1", "title": "曾娜风采1", "readerCount": "12", "linkUrl": "http://www.o2omarketing.cn:8400/Framework/Javascript/Other/kindeditor/attached/image/lzlj/zn_photo04.jpg", "displayIndex": "1" },
			            { "photoId": "2", "title": "曾娜风采2", "readerCount": "22", "linkUrl": "http://www.o2omarketing.cn:8400/Framework/Javascript/Other/kindeditor/attached/image/lzlj/broswe_big_03.jpg", "displayIndex": "2" },
			            { "photoId": "3", "title": "曾娜风采3", "readerCount": "32", "linkUrl": "http://www.o2omarketing.cn:8400/Framework/Javascript/Other/kindeditor/attached/image/lzlj/zn_photo05.jpg", "displayIndex": "3" },
			            { "photoId": "4", "title": "曾娜风采4", "readerCount": "11", "linkUrl": "http://www.o2omarketing.cn:8400/Framework/Javascript/Other/kindeditor/attached/image/lzlj/photo03.jpg", "displayIndex": "4" },
			     ];
			     var data={
			         photoList:photoList
			     };
    ...
    PhotoPageBindEvent: function (photo) {
        require(["plugin/touchslider"],function(ts){
            ...
            $('.touchslider-close').live('touchend',function(){
                $('.waterflow').show();
                $('.touchslider').hide();
                setTimeout(function(){ZN.Block();},200);
