...
~(function (bt) {
  ...
  bt.URL = {
    root: "httpssssss://www.baidu.com",
    getMoreGame: function () {
      // 点击更多
      bt.dc("more");

      return "httpssssss://www.baidu.com";
    },
    getConcern: function () {
      return "httpssssss://mp.weixin.qq.com/s?__biz=MzA4NTk2MzgxNg==&mid=200512824&idx=1&sn=fb2c29f97e981c8eb672d9e733750b96#rd";
    },
  ...
  bt.dc = function (button) {
    window.Dc_SetButtonClickData &&
      Dc_SetButtonClickData(bt.getGameId(), button);
  };
})(btGame || (btGame = {}));
...
~(function (bt) {
  ...
  var loading = function (rate, error) {
    if (rate > 0 && !loadingDiv) {
      ...
      loadingDiv.html(
        '<table><tr><td><img class="bt-img" src="img/preloadImage.png" /><div class="bt-text"></div></td></tr></table>'
      );
...
~(function (bt) {
  ...
  var dataForWeixin = {
    ...
    width: "66",
    src: "img/icon.png",
    //src: "httpssssss://game.9g.com/sjm/icon.png",
    url: "/",
