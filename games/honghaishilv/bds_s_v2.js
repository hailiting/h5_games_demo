  ...
  var Z =
      {
        ...
        render: true,
        snsKey: {},
        bdHost: "httpssssss://bdimg.share.baidu.com/static/",
        bdJump: "httpssssss://share.baidu.com/",
        bdApi: "httpssssss://api.share.baidu.com/",
        bdStatistics: "httpssssss://share.baidu.com/commit",
        bdCommit: "httpssssss://s.share.baidu.com/",
        bdMshare: "httpssssss://s.share.baidu.com/mshare",
        bdCout: "httpssssss://nsclick.baidu.com/v.gif?pid=307",
    ...
    J = {
      ...
      html: function (D, B) {
        ...
        if (B == "link") {
          ...
          return X.insertBefore(
            T,
            B == "iframe" ? X.firstChild : O.nextSibling
          );
        }
      },
      list: function (E) {
      ...
      list_s: function (j) {
        var i = [],
          ...
          e =
            W.bdNums < B.length
              ? '<li><a href="#" class="bds_more">' + W.bdMore + "</a></li>"
              : "";
        while (E--) {
          (U = J.list(B[E])),
            i.push(
              '<a href="' + U.url + '" class="' + U.cls + '">' + U.name + "</a>"
            );
        }
        inner =
          ...
          if (T.bdType == "slide") {
            if (K || g) {
              ...
              _bdS.style.top =
                E.t +
                (U == 0
                  ? E.h / 2 - (V.getElementById(T.bdIdsl).offsetHeight - 11) / 2
                  : parseInt(U)) +
                "px";
            } else {
              if (T.bdTop != 0) {
        ...
        if (D && D != X) {
          if (D.getBoundingClientRect) {
            ...
            while (D) {
              ...
              if (B) {
                var i =
                    parseInt(j.getPropertyValue("border-left-width"), 10) || 0,
      ...
      getMousePos: function (B) {
        ...
        if (document.documentElement && document.documentElement.scrollTop) {
          ...
          if (document.body) {
            return {
              x:
                B.clientX + document.body.scrollLeft - document.body.clientLeft,
    ...
    M = function (B) {
      ...
      O =
        O ||
        J.html(
          { style: "display:none;" + (B || ""), frameBorder: 0 },
          "iframe"
        );
    },
    Q = function (j, n, m, B) {
    ...
    d = {
      create: function () {
        ...
        var U = W || B;
        U.getElementsByTagName("h5")[0].innerHTML =
          (C.title || i.bdPopTitle) + "<b>&nbsp;</b>";
        J.setAttr(U, "display:block;");
        J.setAttr(
          U,
          "left:" +
            (l.w / 2 - U.offsetWidth / 2) +
            "px;top:" +
            (j + l.h / 2 - U.offsetHeight / 2) +
            "px"
        );
        J.setAttr(
          O,
          "position:" +
            e +
            ";display:block;z-index:10000;width:" +
            U.offsetWidth +
            "px;height:" +
            U.offsetHeight +
            "px;left:" +
        ...
        J.on(F, "resize", function (o) {
          var m = J.getSize(),
            n =
              "left:" +
              (m.w / 2 - U.offsetWidth / 2) +
              "px;top:" +
              (j + m.h / 2 - U.offsetHeight / 2) +
              "px";
          J.setAttr(U, n);
          J.setAttr(O, n);
        });
    ...
    a = {
      ...
      _jump: function (AX, AW, B, AE, AD) {
        var AV = Z,
          ...
          p = AV.bdMiniWindow || 0;
        C =
          AW.getAttribute("data") && AW.getAttribute("data") != ""
            ? J._parseJson(AW.getAttribute("data"))
            : C;
        if (C != "") {
          ...
          if (AX == "tsina") {
            ...
            W =
              encodeURIComponent((C.text || "").substr(0, 300)) ||
        ...
        var r =
          ...
          "&sloc=" +
          k +
          "&apiType=0&buttonType=" +
          D +
          "&firstime=" +
          J.getCookie("bdshare_firstime");
        if (AX == "mshare") {
        ...
        if (AX != "goWebsite") {
          ...
          if (AX == "bdxc") {
            ...
            if (AT[AO]) {
              ...
              AK.srchref =
                "httpssssss://xiangce.baidu.com/zt/collect/mark.js?" +
                new Date().getTime();
            ...
            if (AX == "bdysc") {
              ...
              if (window.baiduSC_yaq4d3elabjnvmijccc1zuo3o4yeizck) {
                ...
                AN.srchref =
                  "httpssssss://s.wenzhang.baidu.com/js/pjt/content_ex/page/bookmark.js?s=baidu_fenxiang&_t=" +
                  Math.random();
  ...
  bdShare.fn = (function () {
    return {
        ...
        if (this.s.length > 0) {
          J.callByBrowser(
            this.conf.bdApi +
              "getnum?url=" +
              G +
              "&callback=bdShare.fn._getShare&type=" +
              D +
              "&t=" +
              new Date().getTime()
          );
            ...
            if (q[r].id == "bdshare") {
              ...
              while (U--) {
                ...
                if (/bds_more/.test(e.className)) {
                  ...
                  if (g) {
                    u.style.height =
                      (/bds_tools_32/.test(q[r].className) ? 38 : 17) + "px";
                  }
      ...
      _s: function (W, B, D, U, j) {
        ...
        this._popShow(W, {
          over: function (k) {
            T = J.getPosition(W);
            C =
              U.getAttribute("data") && U.getAttribute("data") != ""
                ? J._parseJson(U.getAttribute("data"))
                : "";
            J.setAttr(B, "display:" + e);
            J.setAttr(
              B,
              "left:" +
                (J.getSize().w - k.clientX < B.offsetWidth
                  ? T.l - B.offsetWidth + W.offsetWidth
                  : T.l) +
                "px"
            );
            J.setAttr(
              B,
              "top:" +
                (J.getSize().h - k.clientY < B.offsetHeight
                  ? T.t - B.offsetHeight
                  : T.t + W.offsetHeight) +
                "px"
            );
      ...
      _slide: function () {
        ...
        J.setAttr(
          E,
          "overflow:hidden;height:330px;position:" +
            W +
            ";top:" +
            i +
            "px;" +
        ...
        J.on(F, "resize", function () {
          J.setAttr(
            E,
            k == "right" ? k + ":" + (J.getSize().w - j.imgW) + "px" : ""
          );
        });
      },
        ...
        if (V.all) {
          ...
          T.onmouseover = function (U) {
            U.relatedTarget == null
              ? E(U)
              : !(
                  this === U.relatedTarget ||
                  this.compareDocumentPosition(U.relatedTarget) == 20
                ) && E(U);
          };
