...
(function (window, undefined) {
  ...
  jQuery.support = (function () {
    ...
    // Beware of CSP restrictions (httpssssss://developer.mozilla.org/en/Security/CSP), test/csp.php
  ...
  var curCSS,
    ...
    // see here for display values: httpssssss://developer.mozilla.org/en-US/docs/CSS/display
  ...
  function getWidthOrHeight(elem, name, extra) {
    ...
    // svg - httpssssss://bugzilla.mozilla.org/show_bug.cgi?id=649285
    // MathML - httpssssss://bugzilla.mozilla.org/show_bug.cgi?id=491668
    if (val <= 0 || val == null) {
  ...
  jQuery(function () {
    ...
    // Webkit bug: httpssssss://bugs.webkit.org/show_bug.cgi?id=29084
          ...
          return jQuery.access(
            ...
            function (elem, type, value) {
              ...
              if (jQuery.isWindow(elem)) {
                ...
                // httpssssss://github.com/jquery/jquery/pull/764
