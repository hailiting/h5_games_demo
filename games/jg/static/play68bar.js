...
function addShareWX() {
  ...
  n.src = "httpssssss://games.vdcom.cn/games/jgfx/static/share.jpg";
  n.id = "share-wx-img";
...
function addWXQR() {
  var e = document.createElement("div");
  e.style.cssText =
    "background:rgba(0,0,0,0.8); position:fixed;top:0px; left:0px; width:100%; height:" +
    document.height +
    "px; z-index:10000; display:none;";
  e.id = "wx-qr";
  e.onclick = closewx;
  document.body.appendChild(e);
  wxqrP1 = document.createElement("p");
  wxqrP1.style.cssText =
    "text-align:center;width:220px;color:#fff;margin:50px auto 0 auto;font: bold 16px Arial, Helvetica, Microsoft Yahei, 微软雅黑, STXihei, 华文细黑, sans-serif";
...
function addShareButtons(e) {
  ...
  wxqrP3.style.cssText =
    "text-align:center;width:" +
    n +
    ";color:#fff;padding-top:5px;margin:0 auto;font: bold 20px Arial, Helvetica, Microsoft Yahei, 微软雅黑, STXihei, 华文细黑, sans-serif";
  wxqrP3.innerHTML = "&quot;" + shareTitle + "&quot;";
...
var HOME_PATH = HOME_PATH || "httpssssss://games.vdcom.cn/games/",
  RESOURCE_IMG_PATH = RESOURCE_IMG_PATH || "../resources/images/",
  HORIZONTAL = HORIZONTAL || false,
  COVER_SHOW_TIME = COVER_SHOW_TIME || 2e3;
var imgUrl = "httpssssss://games.vdcom.cn/games/jgfx/static/icon.png";
var lineLink = "httpssssss://games.vdcom.cn/games/jgfx/";
...
(function () {
  ...
  var e = document.createElement("div");
  e.style.cssText =
    "position:absolute;z-index:1000000;left:0;top:0;background:#e9573f url(" +
    RESOURCE_IMG_PATH +
    "cover.png) no-repeat center center;background-size: 50%;width:" +
    window.innerWidth +
    "px;height:" +
  ...
  t.style.cssText =
    "position:absolute;z-index:999999;left:0;top:0;background:#e9573f url(" +
    RESOURCE_IMG_PATH +
    "rotate_tip.png) no-repeat center center;background-size: 50%;";
