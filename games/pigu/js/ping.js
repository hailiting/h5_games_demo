...
function pgvGetDomainInfo() {
  typeof pvCurDomain != "undefined" &&
    pvCurDomain != "" &&
    (Tcss.dm = pvCurDomain),
    typeof pvCurUrl != "undefined" &&
      pvCurUrl != "" &&
      (Tcss.url = escape(pvCurUrl)),
...
function pgvIsPgvDomain() {
  var e = Tcss.dm.split("."),
    t = Tcss.dm;
  return (
    e.length >= 3 && e[e.length - 2] == "qq" && (t = e[e.length - 3]),
    !/(^qzone$)|(^cache$)|(^ossweb-img$)|(^ring$)|(^im$)|(^fo$)|(^shuqian$)|(^photo$)|(^pet$)|(^r2$)|(^bar$)|(^client$)|(^music$)|(^pay$)|(^sg$)|(^vip$)|(^show$)|(^qqtang$)|(^safe$)|(^service$)|(^love$)|(^mail$)|(^qqgamecdnimg$)|(^netbar$)|(^dnf$)|(^qqgame$)|(^mgp$)|(^magic$)|(^city$)|(^1314$)|(^wb$)|(^qun$)|(^aq$)|(^17roco$)|(^minigame$)|(^cf$)|(^zg$)|(^pc$)|(^shurufa$)|(^live$)|(\.3366\.com$)/.test(
      t
    )
  );
}
function pgvGetRefInfo() {
  typeof pvRefDomain != "undefined" &&
    pvRefDomain != "" &&
    (Tcss.rdm = pvRefDomain),
  ...
  if (pgvIsPgvDomain()) {
    if (Tcss.rdm == "") {
      var e = Tcss.l.href.match(
        new RegExp("[?&#](((pgv_ref)|(ref)|(ptlang))=[^&#]+)(#|&|$)")
      );
...
function pgvGetNewRand() {
  ...
  return (
    u.length > 13 && pgvRealSetCookie("o_cookie="),
    n != pvNone
      ? (pgvRealSetCookie("o_cookie=" + n), "&nrnd=" + n)
      : r != pvNone
      ? (pgvRealSetCookie("o_cookie=" + r), "&nrnd=" + r)
      : s != pvNone
      ? (pgvRealSetCookie("o_cookie=" + s), "&nrnd=" + s)
      : e != pvNone
      ? (pgvRealSetCookie("o_cookie=" + e), "&nrnd=" + e)
      : u != pvNone
      ? "&nrnd=" + u
      : t != pvNone
      ? (pgvRealSetCookie("o_cookie=" + t), "&nrnd=" + t)
      : i != pvNone
      ? (pgvRealSetCookie("o_cookie=" + i), "&nrnd=" + i)
      : o != pvNone
      ? (pgvRealSetCookie("o_cookie=" + o), "&nrnd=" + o)
      : a != pvNone
      ? "&nrnd=F" + a
      : "&nrnd=-"
  );
...
function hotClick() {
  document.addEventListener
    ? document.addEventListener("click", clickEvent, !1)
    : document.attachEvent && document.attachEvent("onclick", clickEvent),
    window.addEventListener
      ? window.addEventListener("onbeforeunload", staybounce, !1)
      : window.attachEvent && window.attachEvent("onbeforeunload", staybounce);
}
...
function clickEvent(e) {
  ...
  try {
    ...
    typeof e.srcElement != "undefined" &&
      e.srcElement == "[object]" &&
      typeof e.srcElement.parentElement != "undefined" &&
      e.srcElement.parentElement == "[object]" &&
      (r = 0),
      (pvClickCount += r);
    var i = new Image(1, 1);
    (i.srchref =
      "httpssssss://trace.qq.com:80/collect?pj=8888&url=" +
      ...
      r +
      "&u=" +
      trimUin(pgvGetCookieByName("o_cookie"))),
      delete i;
  } catch (s) {}
}
function tracert() {
  if (pgvIsPgvDomain()) {
    ...
    sendUrl.srchref = "httpssssss://trace.qq.com:80/collect?" + t;
...
function staybounce() {
  ...
  var e = dt.getTime(),
    t = new Image(1, 1);
  (t.srchref =
    "httpssssss://trace.qq.com:80/collect?pj=8887&url=" +
    escape(location.href) +
    "&t=" +
    parseInt((e - pvStartTime) / 1e3) +
    "&v=" +
    pvClickCount +
    "&u=" +
    trimUin(pgvGetCookieByName("o_cookie"))),
...
(function () {
  ...
  var _d,
    ...
    _crossDomain = 0;
  (_ver = "tcss.3.1.5"),
    (_speedTestUrlhref = "httpssssss://jsqmt.qq.com/cdn_djl.js"),
    (window.Tcss = {});
  var _pgvVersion =
    typeof tracert == "function" &&
    typeof pgvGetColumn == "function" &&
    typeof pgvGetTopic == "function" &&
    typeof pgvGetDomainInfo == "function" &&
    typeof pgvGetRefInfo == "function";
  ...
  tcss.prototype = {
    ...
    run: function () {
      ...
      (e = new Date().getTime()),
        ...
        this.url.unshift(
          "httpssssss://pingfore." +
            this.getCookieSetDomain(_curDomain) +
            "/pingd?"
        ),
        this.url.push(this.getRefInfo(_params));
      try {
        navigator.cookieEnabled
          ? this.url.push("&pvid=" + _cookie.setCookie("pgv_pvid", !0))
      ...
      _params.hot &&
        ...
        _params.repeatApplay &&
          _params.repeatApplay == "true" &&
          typeof _rep != "undefined" &&
          (_rep = 1);
    },
    getSud: function () {
    ...
    getDomainInfo: function (e) {
      var t, n;
      return (
        (t = _l.hostname.toLowerCase()),
        _params.virtualDomain &&
          (_hurlcn.push("ad=" + t), (t = _params.virtualDomain)),
    ...
    getRefInfo: function (e) {
      ...
      var l = t;
      _params.virtualRefDomain &&
        (t != _n && _hurlcn.push("ard=" + t), (t = _params.virtualRefDomain)),
        _params.virtualRefURL &&
          (n != _n && _hurlcn.push("aru=" + escape(n)),
      ...
      _cookie.setCookie(
        "ts_last",
        !0,
        escape((_l.hostname + _l.pathname).substring(0, 128))
      );
      ...
      try {
        ...
        self.screen &&
          ...
          u.language
            ...
            : u.browserLanguage && (r = u.browserLanguage.toLowerCase()),
          (o = u.javaEnabled() ? 1 : 0),
          (i = u.platform),
    ...
    getExtendEnvInfo: function () {
      ...
      try {
        ...
        (e += "&flash=" + this.getFlashInfo()),
          ...
          _b.addBehavior &&
            (_b.addBehavior("#default#clientCaps"), (r = _b.connectionType)),
          (e += "&ct=" + r);
      } catch (i) {
      } finally {
        return e;
  ...
  var _cookie = {
    ...
    getExpires: function (e) {
      var t = new Date();
      return (
        t.setTime(t.getTime() + e * 60 * 1e3), "expires=" + t.toGMTString()
      );
    },
    save: function () {
  ...
  (window.pgvMain = function (e, t) {
    ...
    try {
      _pgvVersion &&
        (typeof pvRepeatCount != "undefined" && pvRepeatCount == 1
          ? ((_rep = 1), (pvRepeatCount = 2))
          : (_rep = 2));
      if (_rep != 1) return;
