...
function hateTiger() {
  ...
  item.each(function (index) {
    ...
    $(this).click(function () {
      ...
      } else if (selectedTd == 4 && $(this).attr("tdId") == 100) {
        //周滨直达大老虎
        big = true;
        TweenLite.to($(self), turn_speed, {
          "z-index": 100,
      ...
      } else if (selectedTd == 1 && $(this).attr("tdId") == 7) {
        //郭永祥兼属于石油系和四川系
        selectRight(this);
      } else if (selectedTd == 2 && $(this).attr("tdId") == 7) {
        //郭永祥兼属于石油系和四川系
...
function share() {
  ...
  if (stage == "android" || stage == "ios") {
    ...
    window.location =
      "httpssssss://game.bkeke.com/index.html?c=share&a=index&url=_url&title=" +
      _title +
      "&pic=" +
      _pic +
      "&line1=";
...
var onBridgeReady = function () {
  ...
  WeixinJSBridge.on("menu:share:timeline", function (argv) {
    var wxTitle = "",
      ...
      _imgurl = "httpssssss://game.bkeke.com/lhpg/icon.jpg",
