var Config = {
  ...
  shareData = {
    imgUrl: "httpssssss://app.46465.com/html5/memeda/logo.png",
    timeLineLink: "httpssssss://app.46465.com/html5/memeda/index.html",
    tTitle: "show girl 么么哒",
    tContent: "爱我你就吻我吧",
  },
  Res = [
    "httpssssss://app.46465.com/html5/memeda/img/1.jpg",
    "httpssssss://app.46465.com/html5/memeda/img/2.jpg",
    "httpssssss://app.46465.com/html5/memeda/img/3.jpg",
    "httpssssss://app.46465.com/html5/memeda/img/4.jpg",
    "httpssssss://app.46465.com/html5/memeda/img/5.jpg",
    "httpssssss://app.46465.com/html5/memeda/img/6.jpg",
    "httpssssss://app.46465.com/html5/memeda/img/7.jpg",
    "httpssssss://app.46465.com/html5/memeda/img/8.jpg",
    "httpssssss://app.46465.com/html5/memeda/img/9.jpg",
    "httpssssss://app.46465.com/html5/memeda/img/10.jpg",
    "httpssssss://app.46465.com/html5/memeda/img/11.jpg",
    "httpssssss://app.46465.com/html5/memeda/img/12.jpg",
    "httpssssss://app.46465.com/html5/memeda/img/13.jpg",
    "httpssssss://app.46465.com/html5/memeda/img/14.jpg",
    "httpssssss://app.46465.com/html5/memeda/img/15.jpg",
    "httpssssss://app.46465.com/html5/memeda/img/80.png",
    "httpssssss://app.46465.com/html5/memeda/img/460.png",
  ],
  timeoutData = [
    {
      max: 30,
...
!(function (a) {
  var b,
    ...
    m = {
      ...
      load: function () {
        function a() {
          c++, b == c && (m.init(), d.switchPage("index"));
        }
        for (var b = Res.length, c = 0, d = this, e = 0; b > e; e++) {
          var f = new Image();
          (f.onload = a), (f.src = Res[e]);
        }
      },
      renderUI: function () {
        var b,
      ...
      tick: function (b) {
        function c(b) {
          return (
            ...
            f >= k && (d(f), (e = b)),
            l._gameover
              ? void (h && a.cancelAnimationFrame(h))
              : l._pause
              ? void (h && a.cancelAnimationFrame(h))
              : void (h = a.requestAnimationFrame(c))
          );
        }
        function d(a) {
          var b = Date.now();
          if (((l.time = b - m), l.time >= Config.allTime))
            return void l.gameOver("timeout");
        ...
        var e,
          ...
          l = this,
          m = Date.now();
        console.log("startTime", m), "resume" == b && (m -= l.time);
        var e = Date.now();
      ...
      setScore: function () {
        (this.score += 1), h.text(this.score);
      },
      again: function () {
        console.log(">> again"), this.start(), this.switchPage("game");
      },
      gameOver: function (a) {
        console.log(">> gameover");
        var b = this;
        (this._gameover = !0), b.switchPage("gameover");
        {
          var c,
            d,
            e,
          ...
          g > 0
            ? "我一分钟亲了" + b.score + "个showgirl！肯定比你多，不信你试试？"
            : shareData.tTitle;
        }
        "timeout" == a
          ? ((c = this.filterText(g, timeoutData)),
            (d = c.desc.replace(/#score#/, g)),
            (e = "恭喜你将她领回家~"),
            (l.title =
              "我亲到" +
              g +
              ...
              h +
              "%的勇士，征服一个领回家，开心过七夕咯~！"))
          : ((c = this.filterText(g, suicideData)),
            (d = c.desc),
            (e = "恭喜你将他领回家~"),
            (l.title =
              g > 0
                ? "万千showgirl丛中过，偏偏眼瞎亲如花！我只击败了全国" +
                  h +
                  "%的勇士……你来试试？"
                : "很遗憾！我没有亲到Showgirl，是全国唯一垫底的勇士！只有如花和我回家！")),
        ...
        console.log(l), $("#gameover").html(j), f.removeClass();
      },
              ...
              WeixinJSBridge &&
                (WeixinJSBridge.on("menu:share:appmessage", function () {
                  ...
                  WeixinJSBridge.invoke(
                    ...
                    function () {
                      document.location.href = "httpssssss://app.46465.com/";
                    }
                  );
                }),
                WeixinJSBridge.on("menu:share:timeline", function () {
                  ...
                  WeixinJSBridge.invoke("shareTimeline", a, function () {
                    document.location.href = "httpssssss://app.46465.com/";
                  });
                }));
          },
      ...
      kiss: function (a, b) {
        var c = $(f[a]),
          d =
            '<img srchref="httpssssss://app.46465.com/html5/memeda/img/460.png" />';
        c.html(d), c.find("img").fadeOut(300, b);
      },
