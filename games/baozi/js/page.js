  ...
  setTimeout(function () {
    ...
    if (eat_count <= 20) {
      ...
      share =
        ...
        eat_count +
        "个包子，打败了5%的人，求填饱";
      share_imgUrl = "httpssssss://games.vdcom.cn/games/baozi/images/c4.png";
    } else {
      if (eat_count <= 35) {
        ...
        if (eat_count <= 50) {
          ...
          share =
            ...
            "个包子，打败了25%的人，求填饱";
          share_imgUrl =
            "httpssssss://games.vdcom.cn/games/baozi/images/c4.png";
        } else {
          if (eat_count <= 65) {
            chat =
              "万万没有想到！你吃了" +
              ...
              if (eat_count <= 95) {
                ...
                if (eat_count <= 110) {
                  chat =
                    "你吃了" +
                    eat_count +
                    "个包子，我看你天赋异禀、骨骼惊奇，想来是百年难得一见的吃货奇才！";
                  share =
                    "我在《金华人吃包子大赛》中吃掉了" +
                    eat_count +
                    "个包子，打败了65%的人，求填饱";
...
$(function () {});
var shareUrl = "httpssssss://games.vdcom.cn/games/baozi/index.html",
  shareTitle = "《金华人吃包子大赛》，求填饱！",
  share = "《金华人吃包子大赛》，求填饱！",
  share_imgUrl = "httpssssss://games.vdcom.cn/games/baozi/images/c4.png";
