...
(function (t) {
  ...
  function n(t) {
    if (((t = t || {}), !t.isMaster))
      throw "The DataStore can only be instantiated by the Master";
    this.dataStore = {};
  }
  function r(t, e) {
    (t = t || {}),
      ...
      (this.timeout = !1),
      (this._callbacks = { pause: !1, resume: !1 }),
      this._setupEvents();
  }
  function i(t, e) {
    (t = t || {}),
      ...
      (this.timeInGameTracking = { started: !1, appid: null, timestamp: null });
  }
  function o(t, e) {
    (t = t || {}),
      (this.IS_MASTER = t.isMaster),
  ...
  function s(t) {
    ...
    if ("string" == typeof t && ((o = t.split("|")), "gameapi" === o[0])) {
      o.shift(),
        ...
        (n = o.join("|"));
      try {
        i = { type: e, callbackId: r, data: "" !== n ? JSON.parse(n) : "" };
      } catch (a) {}
    }
    return i;
  }
  ...
  function c(t, n, r, i, o) {
    (this.version = "0.7.12"),
      ...
      this._setRole(),
      (this.__ = {}),
      (this.__.dataStore = this.IS_MASTER ? new t({ isMaster: !0 }) : null),
      ...
      (this.__.EventTracking = new i(
        { isMaster: this.IS_MASTER, data: null, messenger: this.__.messenger },
        !0
      )),
      (this.GameBreak = new o(
        { isMaster: this.IS_MASTER, messenger: this.__.messenger },
        !0
      ));
  }
  var p;
  (function (t) {
    ...
    function x(t) {
      return function () {
        return M([this, L(arguments)], function (e, n) {
          return t.apply(e, n);
        });
      };
    }
    ...
    var J,
      ...
      H = (function () {
        ...
        if (
          ((H = function (t) {
            (n = n.next = { task: t, domain: o && process.domain, next: null }),
              r || ((r = !0), i());
          }),
    ...
    (p.resetUnhandledRejections = k),
      ...
      (p.allResolved = c(O, "allResolved", "allSettled")),
    ...
    (function (t) {
      ...
      e ||
        ((t.Promise = p.promise),
        (t.Promise.all = p.all),
        (t.Promise.timeout = p.timeout),
        p.stopUnhandledRejectionTracking());
    })(t !== void 0 ? t : this);
  var l = { timeout: 3e3 };
  (l.getGameConfig = function () {
    var t = p.defer();
    return (
    ...
    (l.getBrandingConfig = function (t) {
      var e = p.defer(),
        nhref = "httpssssss://api.configar.org/cf/pb/1/configs",
        r = t.portal.siteId,
        i = t.portal.channelId,
        o = t.portal.applicationId;
      return (
        SpilGames(["Net", "JSLib"], function (t, a) {
          t.send(
            { url: [n, i, r, o].join("/"), type: "GET", dataType: "JSON" },
            function (t) {
  ...
  (f.argsToArray = function (t) {
    ...
    (f.getRole = function () {
      var t =
        "function" == typeof window.SpilGames &&
        window.SpilGamesBootstrap instanceof Array;
      return t ? "master" : "slave";
    }),
      ...
      for (var n in e)
        if (e.hasOwnProperty(n)) {
          if (!t.hasOwnProperty(n))
            return { error: "Wrong argument passed: " + n };
          if (t.hasOwnProperty(n)) {
  ...
  (h.getGameConfig = function () {
    return l.getGameConfig().catch(function () {
      return h.getLocalConfig();
    });
  }),
    (h.getBrandingConfig = function (t) {
      return new Promise(function (e) {
        return l.getBrandingConfig(t).then(e, function (t) {
          e(t);
        });
      });
    }),
    (h.getLocalConfig = function (t) {
      t =
        t && Object.keys(t).length ? t : { portal: {}, game: {}, branding: {} };
      var e = {
        game: {
      ...
      (this._callbacks.pause = t),
        ...
        this.isMaster ||
          this.messenger._postMessage(
            ["log.gameapi.ad.requested", { origin: "slave" }, null],
            null,
            "log"
          ),
    ...
    (r.prototype._onAdAccepted = function (t) {
      ...
      this.timeout && clearTimeout(this.timeout),
        !this.isMaster &&
          t &&
          (e._postMessage(
            ["log.gameapi.ad.start", { origin: "slave" }, null],
            null,
            "log"
          ),
    ...
    (r.prototype._onAdCompleted = function () {
      ...
      this.isMaster ||
        (t._postMessage(
          ["log.gameapi.ad.complete", { origin: "slave" }, null],
          null,
          "log"
        ),
    ...
    (i.prototype.init = function (t) {
      ...
      var e =
          this.data && this.data.game && this.data.game.applicationId
            ? this.data.game.applicationId
            : null,
        n = new Date(),
        r = window.location.hostname;
      (this.IS_SLAVE || f.isWrapped()) && this.startInternalTracking(e, n, r);
    }),
    (i.prototype._createEventObject = function (t, e, n) {
      return { eventCategory: t, eventAction: e, properties: n };
    }),
    (i.prototype._sendSETEvent = function (t, e, n) {
      return (
        this.messenger &&
          (this.IS_SLAVE || f.isWrapped()) &&
          this.messenger.post("tracker.event." + t, e, n),
        e
      );
    }),
    (i.prototype.trackGamePlay = function (t) {
    ...
    (i.prototype.trackTimeInGame = function (t) {
    ...
    (i.prototype.startInternalTracking = function (t, e, n) {
      var r = this,
        i = 6e4,
        o = function (t) {
    ...
    (o.prototype.getLogo = function (t) {
      if (!this.moduleReady)
        return {
          error: "This method cannot be called before the API is loaded",
        };
      ...
      this.messenger._postMessage(
        ["log.branding.getlogo", { origin: e }, null],
        null,
        "log"
      );
      var n,
        r,
        i = {
          type: { type: "String", values: ["png"] },
          width: "Number",
          height: "Number",
        };
      return (
        (n = this._getLink("logo")),
        t &&
          "object" == typeof t &&
          ((r = f.validateSchema(i, t)), r.error && (n.error = r.error)),
        n
      );
    }),
    (o.prototype.getLink = function (t) {
      ...
      if (-1 !== e.indexOf(t)) {
        ...
        return (
          this.messenger._postMessage(
            ["log.branding.getlink", { origin: n, linkName: t }, null],
            null,
            "log"
          ),
          this._getLink(t)
    ...
    (o.prototype._getLink = function (t) {
      if (!t) return { error: "No link identifier provided" };
      ...
      return e && e[t]
        ...
        : { error: "Invalid option: '" + t + "'", action: function () {} };
    }),
    (o.prototype.getLinks = function () {
      var t = {},
        e = this.listLinks();
    ...
    (o.prototype._executeHandler = function (t) {
      var e = this.data && this.data.branding ? this.data.branding : {},
        n = e[t],
        r = n.handler,
      ...
      if (n.url && n.url.length > 0 && r && this.components[r]) {
        ...
        return (
          this.messenger._postMessage(
            ["log.branding.linkAction", { origin: o, linkName: t }, null],
            null,
            "log"
          ),
          this.components[r]({ url: i })
        );
      }
      return function () {};
    }),
    (o.prototype.listLinks = function () {
      var t = [],
    ...
    (o.prototype.getSplashScreen = function () {
      var t,
        e = this.IS_MASTER ? "master" : "slave";
      if (this.data && this.data.branding && this.data.branding.splash_screen) {
        var n = !0;
        this.data.branding.splash_screen.image ||
          this.data.branding.splash_screen.url ||
          (n = !1),
          (t = {
            show: n,
      ...
      return (
        this.messenger._postMessage(
          ["log.branding.splashScreen", { origin: e }, null],
          null,
          "log"
        ),
        t
    ...
    (o.prototype._tagUrl = function (t, e) {
      var n,
        r,
        i,
        o = this.data && this.data.portal ? this.data.portal : {},
        a = this.data && this.data.game ? this.data.game : {},
        s = parseInt(o.siteId, 10);
      if ("string" != typeof t) throw Error("No url specified");
      return (
        (n = "string" == typeof e ? e : "logo"),
        (r = "brandedgame_" + (s > 0 && 500 > s ? "internal" : "external")),
        (i = [
          "utm_medium=" + r,
          "utm_campaign=" + a.applicationId,
          "utm_source=" + o.host,
          "utm_content=" + n,
        ].join("&")),
        (t += t.indexOf("?") > -1 ? "&" : "?"),
    ...
    (u.prototype._postMessage = function (t, e, n) {
      var r, i;
      (r =
        f.isArray(t) && "function" == typeof t[t.length - 1]
          ? this._callbacks.push(t.pop()) - 1
          : e),
        (i = new a({ type: n || "jslib", callbackId: r, data: t }).encode()),
        this._target.postMessage(i, "*");
    }),
    (u.prototype._callJSLib = function () {
      SpilGames.apply(SpilGames, f.argsToArray(arguments));
    }),
    (u.prototype._setupEventListener = function () {
      window.addEventListener
        ? window.addEventListener("message", this._handleMessage.bind(this), !1)
        : window.attachEvent &&
          window.attachEvent("onmessage", this._handleMessage.bind(this));
    }),
    (u.prototype._handleMessage = function (t) {
      var e,
        n,
        r,
        i,
      ...
      return (
        s &&
          ...
          this.IS_MASTER
            ...
            : this.IS_SLAVE &&
              ("function" == typeof i
                ? (delete this._callbacks[n], i(r))
                : "jslib" !== e && this.publish(e, r))),
        !1
      );
    }),
    (u.prototype._handleUGARequest = function (t) {
      var e,
        n,
        r,
        i = this,
    ...
    (u.prototype.post = function () {
      ...
      return (
        this.IS_SLAVE ? this._postMessage(t) : this._callJSLib.apply(this, t),
        this
      );
    }),
    (u.prototype.publish = function (t, e) {
      return (
        this._channels[t] &&
          this._channels[t].forEach(function (t) {
            try {
              t.fn.call(t.ctx, e);
            } catch (n) {}
          }),
    ...
    (u.prototype.subscribe = function (t, e, n) {
      ...
      return (
        ...
        this._channels[t].push({ fn: e, ctx: n }),
        this
      );
    }),
    (u.prototype.unsubscribe = function (t, e) {
      return (
        this._channels[t] &&
          "function" == typeof e &&
          (this._channels[t] = this._channels[t].filter(function (t) {
            return t.fn !== e;
          })),
        this
      );
    }),
    (u.prototype.subscribeOnce = function (t, e, n) {
      function r(n) {
    ...
    (u.prototype.requestFromParent = function (t, e, n) {
      if (!this.IS_SLAVE) throw "You are the parent, stop talking to yourself";
      (e = e || {}), this._postMessage([t, e, n], null, "ugapi");
    }),
    (c.prototype._setRole = function () {
      (this.IS_MASTER = "master" === f.getRole()),
        (this.IS_SLAVE = !this.IS_MASTER);
    }),
    (c.prototype._getTarget = function () {
    ...
    (c.prototype.loadAPI = function (t) {
      function e(e) {
        return (
          r.IS_MASTER && (e = n(e)),
          r.Branding.init({ data: e }),
          r.__.EventTracking.init({ data: e }),
          (r.isReady = !0),
          r.__.messenger._postMessage(
            [
              "log.gameapi.loadapi.finish",
              { origin: i, version: r.version },
              null,
            ],
            null,
            "log"
      ...
      function n(t) {
        var e = t.game || {},
          ...
          r = t.portal || {},
          i = t.branding || {};
        return h.getLocalConfig({ game: e, user: n, portal: r, branding: i });
      }
      var r = this,
        i = this.IS_MASTER ? "master" : "slave";
      return !0 === this.isReady
        ? (window.console &&
            window.console.log &&
            console.log(
          ...
          t(r))
        : (this.__.messenger._postMessage(
            [
              "log.gameapi.loadapi.start",
              { origin: i, version: r.version },
              null,
            ],
            null,
          ...
          this.IS_MASTER
            ? h.getGameConfig().then(function (t) {
                h.getBrandingConfig(t).then(function (i) {
                  t &&
                    !t.isError &&
                    ((t.branding = i.branding), r.__.dataStore._setCache(n(t))),
                    e(t);
                });
              })
  ...
  var d = new c(n, u, o, i, r);
  "function" == typeof define && define.amd && define("GameAPI", d),
    (t.GameAPI = d);
})(window);
