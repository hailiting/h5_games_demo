...
(bdShare._LogPool = bdShare._LogPool || []),
  bdShare.ApiPVLogger ||
    (function (e) {
      ...
      function a() {
        ...
        for (var n = e.length - 1; n >= 0; n--) {
          var r = e[n],
            i = t[r.key];
          i
            ? ((i.linkid = i.linkid || r.api.linkid),
              (i.type = (i.type || 0) | (r.api.type || 0)))
            : (t[r.key] = r.api);
        }
        e = [];
      ...
      function f() {
        ...
        if (t > 0) {
          ...
          for (var l = 0; l < t; l++)
            (s = e[l]),
              (f[r[s.key]] = 1),
              s.api.linkid && ((i = s.api.linkid), delete s.api.linkid),
              n.push(u(s.key, s.api));
          n.unshift("linkid=" + i),
            n.unshift("apitype=" + parseInt(f.reverse().join(""), 2)),
            o(n.join("&"));
        }
      }
      function c() {
      ...
      var t,
        n = (t = n || { version: "1.5.2.2" });
      (n.guid = "$BAIDU$"),
        (n.$$ = window[n.guid] = window[n.guid] || { global: {} }),
        (n.ajax = n.ajax || {}),
        (n.fn = n.fn || {}),
        (n.fn.blank = function () {}),
              ...
              a == "GET" &&
                ...
                r.noCache &&
                  (e +=
                    ...
                    +new Date() +
                    "=1")),
              o ? d.open(a, e, s, o, u) : d.open(a, e, s),
              s && (d.onreadystatechange = v),
              a == "POST" &&
                d.setRequestHeader(
                  "Content-Type",
                ...
                : document.attachEvent &&
                  (n = function () {
                    document.readyState === "complete" &&
                      (document.detachEvent("onreadystatechange", n), r());
                  }),
              s(),
              function (e) {
        ...
        (t.undope = !0);
      var r = { cite: 0, img: 1, addto: 2, video: 3 },
        ...
        o = function (e) {
          var t = document.body.offsetWidth,
            ...
            o = [t, n, r, i].join(","),
            uhref =
              "httpssssss://nsclick.baidu.com/v.gif?pid=307&type=3071&sc=" +
              o +
              "&desturl=" +
        ...
        h = function () {
          var e = +new Date(),
            n = { spendTime: 0, scrollTop: 0, viewHeight: 0 },
            r = +new Date(),
            i = function () {
              var e = new Date() - r;
              if (e > n.spendTime) {
          ...
          setInterval(function () {
            ...
            o(window, "beforeunload", function () {
              ...
              i();
              var o = [
                "httpssssss://nsclick.baidu.com/v.gif?pid=307",
                "type=3075",
                "l=" + r,
                "t=" + n.scrollTop,
                "s=" + n.spendTime,
              ...
              /firefox\/(\d+\.\d+)/i.test(navigator.userAgent)
                ? t.ajax.request(o, { async: !1, timeout: 300 })
                : s(o);
            });
        },
        p = (function () {
              ...
              if (bdShare.velocity) {
                var t =
                    Math.max(
                      bdShare.velocity.cssLoadEnd,
                      bdShare.velocity.mainJsLoaded
                    ) - bdShare.velocity.start || 0,
                  n =
                    bdShare.velocity.cssLoadEnd -
                      bdShare.velocity.cssLoadStart || 0,
                  r =
                    bdShare.velocity.mainJsLoaded - bdShare.velocity.start || 0;
                bdShare._LogPool.length > 0 &&
