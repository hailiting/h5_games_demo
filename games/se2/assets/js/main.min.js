...
var _lang = {
  ...
  shareData = {
    imgUrl:
      "httpssssss://1.txst2008.sinaapp.com/knyds2/assets/img/find.logo.png?ver=1.1.62", //分享时图标地址
    timeLineLink: "httpssssss://1.txst2008.sinaapp.com/knyds2/", //分享时的url
    tTitle: "看你有多色?", //分享的标题
      ...
      c = {
        ...
        init: function (a, c, d) {
          (this.type = a),
            ...
            b.mode
              .data("type", "color" == a ? "color2" : "color")
              .html("color" == a ? this.lang.btn_double : this.lang.btn_normal),
            this.reset(),
            (this.parent = d),
            (this.el = c),
            this.renderUI(),
