$(document).ready(function () {
  ...
  function go() {
    ...
    way = "onTheWay";
    $(".boat").animate(toAni, "normal", "swing", function () {
      way = toWay;
...
(function () {
  ...
  ga.async = true;
  ga.src = "httpssssss://games.vdcom.cn/games/";
...
var mebtnopenurl = "httpssssss://games.vdcom.cn/";
window.shareData = {
  imgUrl: "httpssssss://games.vdcom.cn/games/selang/icon.png",
  timeLineLink: "httpssssss://games.vdcom.cn/games/selang/",
  tTitle: "小心色狼-微营销娱乐游戏",
...
function successHandler(m, t) {
  ...
  document.title =
    t / 1000 + "秒！微营销娱乐游戏《小心色狼》我刚通过了！你敢不敢和我比一下？";
...
function failHandler(t) {
  ...
  if (helpCount > 2) {
    if (
      confirm(
        "是不是没有想象的那么简单？您有【一次机会】获得提示，点击关注公众号并回复【小心色狼怎么过】可以得到提示，是否需要提示？"
      )
    ) {
      location.href =
        "httpssssss://mp.weixin.qq.com/s?__biz=MzA4NTk2MzgxNg==&mid=200512824&idx=1&sn=fb2c29f97e981c8eb672d9e733750b96#rd";
    }
    helpCount = 0;
  }
}
