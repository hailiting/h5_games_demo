...
Auth9G = function (gameid) {
  ...
  this.baseUrl = "httpssssss://games.vdcom.cn/";
  this.gameUrl = "httpssssss://games.vdcom.cn/";
  this.init();
};
...
Auth9G.prototype.check = function () {
  ...
  if (sessionStorage.errcode != undefined) {
    console.log(
      "errcode=" + sessionStorage.errcode + ", errmsg=" + sessionStorage.errmsg
    );
