(function () {
  ...
  function km() {
    ...
    (a.kn = 40),
      ...
      (a.kc = [0, 0.003, 0.004, 0.005, 0.006, 0.008, 0.01, 0.04, 0.08]),
      (a.d8 = [
        0,
        0.003 * 0.8,
        0.0032,
      ...
      (a.dc.dv = "Rate/Review"),
      (a.dc.dn =
        "If you are enjoying playing Pathuku, help us by giving us a good review/rating. \n \nThanks \nPathuku Team"),
      (a.ks = []),
      (a.ka = [
        "this is madness",
        "please try harder.",
        "hurry up, you're wasting your battery!",
      ]);
  }
    ...
    (o.ls = []),
      ...
      d != UD
        ? ((o.pn = 360 / e),
          ...
          (o.zI = g),
          (o.Y = h),
          (o.color = i == UD ? new qg(255, 255, 255) : i))
        : ((o.pn = 360 / c.ls),
          (o.ls[pZ] = c.ls),
          (o.Uz = c.Uz),
          (o.qmzZ = c.qmzZ),
      ...
      (o.gI = 0),
      (o.yq = 0);
    for (l = 0, m = mr, n = mn; l < o.ls[pZ]; l++)
      o.ls[l] = new _tmppp(j + n(m() * k), m() * o.Y);
  }
  function _tmppp(a, b) {
  ...
  function _m() {
    ...
    (a.db = UD),
      tq &&
        ...
        a.db.zo(function (a) {
          a.executeSql(
            "CREATE TABLE IF NOT EXISTS rbMemory(NamePK TEXT PRIMARY KEY,Val TEXT)"
          );
        }, a.zA),
        a.db.zo(function (a) {
          zK("Create"),
            a.executeSql("INSERT INTO rbMemory (NamePK,Val) VALUES (?,?)", [
              "rbdata",
              "nothinge",
            ]);
        }, a.zA));
  ...
  function _Uw(a, b, c, d, e, f, g) {
    (this.gds = [
      new Uc(a, b, c, d, e, f, g),
      new u2(a, b, c, d, e, f, g, 1),
      new u2(a, b, c, d, e, f, g, 2),
      new uk(a, b, c, d, e, f, g),
    ]),
      (this.eE = this.gds[0]);
  }
  ...
  var uf, width, height, zl, zL, _, length, W_, w_, pZ, zK, a1, tq, mm;
  (function () {
    var a = {
        x: 0,
        y: 0,
          ...
          c.z9[Zs] != UD &&
            ...
            (c.zm.onclick = function (a) {
              ...
              (this.zF.UG = a1),
                ...
                b == UD && (b = event),
                this.zF.g.onclick(
                  b.clientX - this.zF.zD,
                  b.clientY - this.zF.ut
                );
              try {
                a.preventDefault(), (a.bubbles = tq);
              } catch (c) {}
            ...
            b.dj != UD && (c.dj = b.dj),
            c.resize(a1),
            (c.g = new _g(c.z9, c.zm, c.zc, c.r, c.R, c[W_], c[w_])),
            (c.g.zP = c.zP),
            b.ZC != UD &&
              ((c.g.ZC = b.ZC),
              (c.g.Zc = b.Zc),
              ...
              (c.g.d3 = b.d3)),
            b.dp != UD && (c.g.dp = b.dp),
            b.dg != UD && (c.g.Y4.dg = b.dg),
            b.UJ != UD && (c.g.UJ = b.UJ),
            b.gC != UD && (c.g.gC = b.gC),
            b.handle != UD && (b.handle = c),
            b.dz != UD && (c.dz = b.dz),
            (c.g.de = function () {}),
            c.g.sLs(a),
      ...
      resize: function (a) {
        ...
        navigator.userAgent.match(/Android/i)
          ? (window.scrollTo(20, 20),
            (k.uI = 0),
            (k.dh =
              window.devicePixelRatio < 1 || window.devicePixelRatio == UD
                ? 1
                : window.devicePixelRatio))
          : (window.scrollTo(0, 1),
            window.navigator.standalone ? (k.uI = 20) : (k.uI = 0)),
          (b = window.innerWidth),
          ...
          (g = 720),
          (h = k.rD),
          (b > f * k.dh && c > g * k.dh) || (c > f * k.dh && b > g * k.dh)
            ? ((d = f), (e = g), (k.rD = 18), (k.RD = 12))
            : ((k.rD = 12), (k.RD = 8)),
    ...
    (km[_] = {
      ki: function (a) {
        ...
        a == null ? ((c = mf(mr() * d.kj[pZ])), (b = d.kj[c])) : (b = d.kj[a]),
          ...
          (d.db.kV = 170),
          (d.kD = d.kC.kX(20)),
          (d.kS = new qg(0, 0, 0, 0.4)),
          (d.d9 = d.kD.kX(80).gL(0.7)),
          (d.d0 = d.kD.kX(-250).gL(0.5)),
          (d.dq = d.kD.kX(-250).gL(0.5)),
          (d.dw = d.kD.kX(-190).gL(0.6)),
          (d.dy = d.kD.kX(-200).gL(0.6)),
          (d.kA = 30),
          (d.kO = d.kl),
          (d.kP = d.kl.kX(80)),
          (d.KW.color = d.kP);
    ...
    (wF[_] = {
      draw: function () {
        ...
        c.s.save(),
          ...
          c.s[Zh]();
        for (a = 0; a < c.ps; a++)
          (b = mP * ((a * c.uz + c.angle) / 360)),
            a == 0
              ? c.t == "qd" && a % 2 == 0
                ? c.s[UO](
                    c.zV.x + c.raduis * 0.4 * ms(b),
                    c.zV.y + c.raduis * 0.4 * mc(b)
                  )
                : c.s[UO](c.zV.x + c.raduis * ms(b), c.zV.y + c.raduis * mc(b))
              : c.t == "qd" && a % 2 == 0
              ? c.s[Zg](
                  c.zV.x + c.raduis * 0.4 * ms(b),
                  c.zV.y + c.raduis * 0.4 * mc(b)
                )
              : c.s[Zg](c.zV.x + c.raduis * ms(b), c.zV.y + c.raduis * mc(b));
    ...
    (_cr[_] = {
      ...
      T: function (a, b) {
        ...
        if (g.cH < g.cHs[pZ] - 1) {
          ...
          (f = new Object()),
            g.cHs[g.cH].t > 1
              ? (g.cHs[g.cH].ge && (h = 1 - h),
                (f.x = g.cHs[g.cH].bez.mx(h)),
                (f.y = g.cHs[g.cH].bez.my(h)))
              : ((f.x =
                  g.cHs[g.cH].x + (g.cHs[g.cH + 1].x - g.cHs[g.cH].x) * h),
                (f.y =
                  g.cHs[g.cH].y + (g.cHs[g.cH + 1].y - g.cHs[g.cH].y) * h)),
            g.uE(f);
        }
      },
      Uds: function (a, b) {
      ...
      Ud: function (a, b) {
        ...
        if (
          f.cHs[pZ] > 1 &&
          f.cHs[f.cHs[pZ] - 1].x == a.x &&
          f.cHs[f.cHs[pZ] - 1].y == a.y
        ) {
          a.t > 1 &&
            ((a.bez = new z2(a.s, a.cp1, a.cp2, a.e, a.t)),
            (a.zn = a.bez[pZ]),
            (a.ge = b),
            f.ZMHs(f.cHs[f.cHs[pZ] - 1], a));
          return;
        }
        (f.cHs[f.cHs[pZ]] = a),
          a.t > 1
            ? ((a.bez = new z2(a.s, a.cp1, a.cp2, a.e, a.t)),
              ...
              f.cHs[pZ] > 1 &&
                ((c = f.cHs[f.cHs[pZ] - 2]),
                (f.cHs[f.cHs[pZ] - 2].zn = a.bez[pZ]),
                c.x == a.s.x && c.y == a.s.y && f.ZMHs(c, a)))
            : f.cHs[pZ] > 1 &&
              f.cHs[f.cHs[pZ] - 2].t < 2 &&
              ((d = f.cHs[f.cHs[pZ] - 2].x - f.cHs[f.cHs[pZ] - 1].x),
              (e = f.cHs[f.cHs[pZ] - 2].y - f.cHs[f.cHs[pZ] - 1].y),
              (f.cHs[f.cHs[pZ] - 2].zn = mS(d * d + e * e)),
              f.cHs[f.cHs[pZ] - 2].zn == 0 && zK("oh no"));
      },
      ZMHs: function (a, b) {
        var c = a.s,
          d = a.cp1,
    ...
    (un[_] = {
      ...
      Zv: function () {
        ...
        c.save(),
          c[Zh](),
          (c[ZJ] = 2),
          (c[Zk] = b.g.S.kD.gL(0.7)),
          (a = c.createLinearGradient(0, 3, 0, 25)),
          a.addColorStop(0, b.g.S.d9),
          a.addColorStop(0.3, b.g.S.d0),
          a.addColorStop(0.6, b.g.S.dq),
      ...
      zk: function (a) {
        ...
        return a > 0
          ? ((b = a + ""),
            a > 999 || (a > 99 ? (b = "0" + b) : (b = "00" + b)),
            (c = b[pZ] - 1),
            b.substring(0, c - 2) + ":" + b.substring(c - 2, c))
          : "0:00";
      },
    }),
    (um[_] = {
    ...
    (_aJ[_] = {
      ...
      KX: function (a, b) {
        ...
        d.KC = UD;
        for (c = 0; c < d.aJ[pZ]; c++)
          if (d.aJ[c].ud(a, b)) return (d.KC = d.aJ[c]), d.aJ[c];
      },
      clear: function (a, b) {
    ...
    (z3[_] = {
      ud: function (a, b) {
        var c = this;
        return a > c.x && a < c.x + c[W_] && b > c.y && b < c.y + c[w_]
          ? a1
          : tq;
      },
    }),
    ...
    (z2[_] = {
      map: function (a) {
        var b,
          ...
          g = 0;
        while (e < f)
          (g = e + (((f - e) / 2) | 0)), c.gH[g] < d ? (e = g + 1) : (f = g);
        return (
          c.gH[g] > d && g--,
          (b = c.gH[g]),
      ...
      x: function (a) {
        var b = this;
        return b.t == 3
          ? b.a.x + a * (2 * (1 - a) * (b.b.x - b.a.x) + a * (b.d.x - b.a.x))
          : (1 - a) * (1 - a) * (1 - a) * b.a.x +
              3 * (1 - a) * (1 - a) * a * b.b.x +
              3 * (1 - a) * a * a * b.c.x +
              a * a * a * b.d.x;
      ...
      y: function (a) {
        var b = this;
        return b.t == 3
          ? b.a.y + a * (2 * (1 - a) * (b.b.y - b.a.y) + a * (b.d.y - b.a.y))
          : (1 - a) * (1 - a) * (1 - a) * b.a.y +
              3 * (1 - a) * (1 - a) * a * b.b.y +
              3 * (1 - a) * a * a * b.c.y +
              a * a * a * b.d.y;
    ...
    (zU[_] = {
      uC: function () {
        var a,
          ...
          d = c.text.split(" "),
          e = 0;
        for (a = 0, b = d[pZ]; a < b; a++)
          c.measureText(c.r[e] + " " + d[a]) <= c[W_] &&
          d[a].indexOf("\n") == -1
            ? (c.r[e] += d[a] + " ")
            : (e++, (c.r[e] = d[a] + " "));
        (c[w_] = c.r[pZ] * (c.textHeight + c.textLineSpacing)), (c.uW = a1);
      },
      fillText: function (a, b) {
        ...
        for (d = 0, e = b, f = g.r[pZ]; d < f; d++)
          g.s[ZH](g.r[d], a, e), (e += c + g.textLineSpacing);
      },
    ...
    (_g[_] = {
      ...
      T: function () {
        ...
        a.u0 || (a.aB = new Date().getTime()),
          ...
          a.u9 && (a.u9 = tq);
        if (!a.qw || !a.aS)
          a.zw && !a.qw && !a.qq && (a.time += a.aB - a.aA), (a.zX.Zz = a.time);
        a.KV(a.aJ.KC),
          a.cr.T(a.aB, a.aA),
          a.zX.T(),
          a.UF(a.aB, a.aA),
            ...
            ? a.KN == 0
              ...
              ? ((d = new h(g[W_] - 32, 20)),
                (e = new wF(
                  ...
                  3,
                  90,
                  new qg(255, 255, 255, 0.8),
                  new qg(40, 40, 40, 0.2)
                )),
                (e[ZK] = new qg(255, 255, 255)),
                e.draw())
              : a.KN == 2
              ? ((d = new h(32, 20)),
                (f = new wF(
                  ...
                  30,
                  new qg(255, 255, 255, 0.8),
                  new qg(255, 255, 255, 1)
                )),
                (f[ZK] = new qg(255, 255, 255)),
                f.draw())
              : g.O.uy(b, a.x - 1, a.y - 1, a[W_] + 2, a[w_] + 2, 5, tq, a1)
            : g.hoverd1 != UD &&
              (b[Zh](),
              (b[Zk] = "rgba(255,255,255,0.9)"),
              (b.shadowBlur = 6),
              (b[ZJ] = 3),
              b.arc(g.z1(g.hoverd1.x), g.zB(g.hoverd1.y), 18, 0, mP, a1),
              b[ZF]()),
          b[ZS]();
      },
      pause: function (a) {
      ...
      uZ: function (a, b) {
        var c = this;
        c.zG(c.level), c.uq(), c.UE(), c.Y4.ZB(c.s, a, b), c.dr(a1);
      },
      KO: function () {
        var a = this;
        a.uq(),
      ...
      pw: function () {
        ...
        (d.qq = a1),
          ...
          (a.last = d.zX.Zz);
        if (d.zX.Zz < a.KY || a.KY == 0)
          (a.KY = d.zX.Zz), (d.zX.KY = d.zX.Zz), (e = a1);
        (a.qds = 1),
      ...
      qh: function () {
        ...
        for (a = 0, b = m[pZ]; a < b; ++a) {
          ...
          if (c != UD) {
            ...
            c.qds > 0 &&
              (m[a].t != UD ? l.t[m[a].t]++ : (l.t[2] = (l.t[2] | 0) + 1),
              (f = m[a].d[pZ] * k.S.kx - c.KY),
              f > 150 ? (l.zjpr += f) : (l.zjpr += 150)),
              (l.KU += c.KU);
          }
        }
        (g = l.qds[0]), (h = 0);
        for (a = 0, b = k.S.kg[pZ]; a < b; ++a)
          g >= k.S.kg[a][0] &&
            ((l.rank = k.S.kg[a][1]),
            a + 1 < b ? (h = k.S.kg[a + 1][0]) : (h = k.S.kg[a][0]));
        i = "";
        for (a = 0, b = k.S.kf[pZ]; a < b; ++a)
          l.qds[k.S.kf[a][0]] / h >= k.S.kf[a][1] && (i = k.S.kf[a][2]);
        return (
          (l.rank += " " + i),
      ...
      uA: function (a, b, c) {
        var d,
          ...
          i = UD,
          j = new h(a, b);
        for (d = 0; d < f.level.d[pZ]; d++)
          (e = f.pB(j, f.pN(f.level.d[d]))),
      ...
      dR: function () {
        var a = this;
        a.dW == 1
          ? ((a.UJ = mf(mr() * a.levels[pZ])), a.ds() && a.sL(a.levels[a.UJ]))
          : a.UJ + 1 < a.levels[pZ]
          ? (a.UJ++, a.aJ.clear(), a.ds() && a.sL(a.levels[a.UJ]))
      ...
      sLs: function (a) {
        var b,
          c,
          d = this;
        (d.UV = a.version), (d.levels = []), (d.gE = [[], [], [], a.levels]);
        for (b = 0, c = d.gE[3][pZ]; b < c; b++)
          d.gE[3][b].id != UD && d.gE[3][b].id != "" && d.gE[3][b].id != "",
            (d.gE[3][b].iid = b + 1),
            d.gE[3][b].t != UD
              ? d.gE[d.gE[3][b].t].push(d.gE[3][b])
              : d.gE[2].push(d.gE[3][b]);
        d.uu(0);
      },
      uu: function (a) {
        var b = this;
      ...
      zG: function (a, b, c) {
        ...
        for (d = 0; d < a.l[pZ]; d++)
          d == 2 && tq ? e.ur(e.s, oqst, oCp1, oEnd) : e.pl(a.l[d], b);
      ...
      Um: function (a) {
        var b,
          c = {};
        for (b in a)
          typeof a[b] == "object" ? (c[b] = this.U2(a[b])) : (c[b] = a[b]);
        return c;
      },
      U2: function (a) {
        function b() {}
      ...
      zO: function (a) {
        var b,
          ...
          o = a;
        for (b = 0; b < o.l[pZ]; b++)
          for (c = 1; c < o.l[b].p[pZ]; c++)
            o.l[b].p[c].x > j && (j = o.l[b].p[c].x),
        ...
        for (b = 0; b < o.l[pZ]; b++) {
          f = n.u8();
          for (c = 0; c < o.l[b].p[pZ]; c++)
            (g = f.Ue(o.l[b].p[c].x + d, o.l[b].p[c].y + e, o.l[b].p[c].t)),
              o.l[b].p[c].s != UD &&
                ((g.s = new h(o.l[b].p[c].s.x + d, o.l[b].p[c].s.y + e)),
                (g.cp1 = new h(o.l[b].p[c].cp1.x + d, o.l[b].p[c].cp1.y + e)),
                (g.cp2 = new h(o.l[b].p[c].cp2.x + d, o.l[b].p[c].cp2.y + e)),
                (g.e = new h(o.l[b].p[c].e.x + d, o.l[b].p[c].e.y + e)));
        }
      ...
      ZM: function (a) {
        var b = 0;
        this.zP
          ? ((b = this.r - 1 - a.x), (a.x = a.y), (a.y = b))
          : ((b = a.x), (a.x = this.R - 1 - a.y), (a.y = b));
      },
      pl: function (a, b) {
        var c,
          d,
        ...
        g == UD && (a.selected ? (g = f.S.klpb) : (g = f.S.kl)),
          ...
          (f.s.lineJoin = "round");
        for (c = 0; c < a.p[pZ]; c++)
          (a.p[c].t != 2 && a.p[c].t != 3) || a.p[c].cp2 == UD
            ? ((d = f.z1(a.p[c].x)),
              (e = f.zB(a.p[c].y)),
              c == 0
                ? f.s[UO](d, e)
            ...
            : (f.s[Zh](),
              ...
              (f.s[ZJ] = f.S.d7 + 6),
              a.p[c].t == 3
                ? f.ur(f.s, a.p[c].s, a.p[c].cp1, a.p[c].e)
      ...
      zJ: function (a, b) {
        ...
        d == UD && (a.selected ? (d = c.S.kl) : (d = c.S.kl)),
          ...
          c.s.fill(),
          (c.s[ZJ] = 2),
          (c.s[Zk] = d.kX(-60).gL(0.4)),
          c.s[ZF](),
          a.selected &&
            (c.s[Zh](),
            (c.s[ZK] = new qg(255, 255, 255).gL()),
            c.s.arc(e, f, c.S.d7 + 1, 0, mP, a1),
            c.s.fill(),
            (c.s[ZJ] = 2),
            (c.s[Zk] = d.kX(-60).gL(0.4)),
            c.s[ZF]());
      ...
      zQ: function () {
        var a;
        for (a = 0; a < this.level.l[pZ]; a++)
          if (!this.level.l[a].selected) return tq;
        return a1;
      },
      KL: function (a, b, c, d) {
        var e, f;
        d || a.indexOf("mailto:") > -1
          ? (window.location = a)
    ...
    (_m[_] = {
      save: function (a, b) {
        var c = "rb" + a;
        this.db
          ? this.db.zo(function (a) {
              a.executeSql("UPDATE rbMemory SET Val=? WHERE NamePK=?", [
                JSON.stringify(b),
                c,
              ]);
            }, this.zA)
          : window.localStorage != UD &&
      ...
      read: function (uV, oObj) {
        ...
        return (
          that.db
            ? that.db.zo(function (a) {
                zK("before select" + sRbKey),
                  a.executeSql(
                    "SELECT Val FROM rbMemory WHERE NamePK=?",
                    [sRbKey],
                    function (a, b) {
                      var c, d;
                      for (c = 0, d = b.r[pZ]; c < d; c++)
                        zK(b.r.item(c).Val), (sJson = b.r.item(c).Val);
                    },
                    UD,
                    that.zA
                  );
            ...
            : window.localStorage != UD &&
              (sJson = window.localStorage.getItem(sRbKey)),
          eval("sJson=" + sJson),
          sJson
        );
      },
    ...
    (_gc[_] = {
      draw: function (a) {
        ...
        s.g.zP ? ((s.R = w), (s.r = v)) : ((s.R = v), (s.r = w)),
          a == UD
            ? ((u = mf(s.g.UJ / (s.R * s.r))), (t = s.R * s.r * u))
            : (t = s.R * s.r * a),
          (b = 10),
          (c = (s.g[W_] - b * 3) / s.R),
          (d = (s.g[w_] - 50) / s.r),
          ...
          (s.s.shadowBlur = 10),
          s.R * s.r * (u + 1) < s.g.levels[pZ] &&
            ((j = new h(s.g[W_] - (b * 2 + 12), 20)),
            (k = new wF(
              s.s,
              j,
              10,
        ...
        for (m = 0; m < s.r; m++) {
          ...
          for (o = 0; o < s.R; o++) {
            (p = 20 + o * c),
              ...
              s.g.UJ == t
                ? ((s.s[Zk] = "rgb(255,255,255)"), (s.s[ZJ] = 4))
                : ((s.s[ZJ] = 2), (s.s[Zk] = s.g.S.kC.gL())),
              (q = s.s.createLinearGradient(0, n, 0, n + f)),
              q.addColorStop(0, s.g.S.d9),
              q.addColorStop(0.2, s.g.S.d0),
              q.addColorStop(0.5, s.g.S.dq),
              ...
              s.g.aDs.uD(function (a) {
                a.levelID != 17 || a.qds == 3,
                  a.s.save(),
                  a.g.zP
                    ? a.s.translate(a.x + a.zC * 1.8 - 10, a.y)
                    : a.s.translate(a.x + a.zC * 1.8, a.y),
                  a.s[hardScale](i, i),
                  (a.s.globalAlpha = 0.5),
    ...
    (_Y4[_] = {
      ZN: function (a) {
        var b,
          ...
          f = 0,
          g = new Array();
        (g[g[pZ]] = new _Y4I("继续", function () {
          this.g.pause(tq), (this.g.aJ.aJ[pZ] = 1);
        })),
          (g[g[pZ]] = new _Y4I("重新开始", function () {
            var a;
          ...
          (g[g[pZ]] = new _Y4I(
            "分享",
            function (a) {
              this.g.aJ.clear(), this.g.uZ(1, a);
            },
            b
          )),
          (g[g[pZ]] = new _Y4I("切换游戏难度", function () {
            this.g.aJ.clear(0, a1), this.g.KG();
          })),
          (g[g[pZ]] = new _Y4I("主菜单", function () {
      ...
      Zn: function (a) {
        ...
        i.g.aJ.clear(),
          (b = g[g[pZ]] =
            new _Y4I(
              "开始 (" +
                (i.g.UZ.t[0] + i.g.UZ.t[1] + i.g.UZ.t[2]) +
                "/" +
                (i.g.gE[0][pZ] + i.g.gE[1][pZ] + i.g.gE[2][pZ]) +
                ")",
              function () {
                i.g.aJ.clear(0, a1), i.g.KG();
              }
            )),
          i.dg != UD && (g[g[pZ]] = new _Y4I(i.dg[0], i.dg[1])),
          (b = g[g[pZ]] =
            new _Y4I("分享", function () {
              i.g.aJ.clear(),
                i.g.uZ(0, function () {
                  i.g.aJ.clear(), i.g.u7();
                });
          ...
          /*
			...
			*/
          (g[g[pZ]] = new _Y4I("游戏说明", function () {
            i.g.aJ.clear(), i.g.d5(0);
          })),
          (g[g[pZ]] = new _Y4I("更多游戏", function () {
          ...
          i[W_] < i[w_]
            ...
            : ((c = 360 + i.zC * 4),
              ...
              (f = 55 + (i[w_] - e.y) / 2),
              i.zv(a, e, "主菜单", "", ""),
              i.Ui(a, d + i.zC, f + i.da, 180, 0, g.slice(0, 3)),
              i.Ui(a, d + i.zC * 3 + 180, f + i.da, 180, 0, g.slice(3)));
      },
      KF: function (a) {
        var b, c;
        this.g.aJ.clear(),
          ...
          (c = b[b[pZ]] =
            new _Y4I(
              "容易 (" + this.g.UZ.t[0] + "/" + this.g.gE[0][pZ] + ")",
              function () {
                this.g.aJ.clear(), this.g.uu(0), this.g.gD();
              }
            )),
          (c.selected = this.g.gC == 0),
          (c = b[b[pZ]] =
            new _Y4I(
              "中等 (" + this.g.UZ.t[1] + "/" + this.g.gE[1][pZ] + ")",
              function () {
                this.g.aJ.clear(), this.g.uu(1), this.g.gD();
              }
            )),
          (c.selected = this.g.gC == 1),
          (c = b[b[pZ]] =
            new _Y4I(
              "难 (" + this.g.UZ.t[2] + "/" + this.g.gE[2][pZ] + ")",
              function () {
                this.g.aJ.clear(), this.g.uu(2), this.g.gD();
              }
            )),
          ...
          (c = b[b[pZ]] =
            new _Y4I(
              "所有 (" +
                (this.g.UZ.t[0] + this.g.UZ.t[1] + this.g.UZ.t[2]) +
                "/" +
                (this.g.gE[0][pZ] + this.g.gE[1][pZ] + this.g.gE[2][pZ]) +
                ")",
              function () {
                this.g.aJ.clear(), this.g.uu(-1), this.g.gD();
              }
      ...
      ZB: function (a, b, c) {
        ...
        for (h = 0, i = m[pZ]; h < i; h++)
          (j = m[h]),
            j[2] != "" &&
              !(j[1].indexOf("mailto:") > -1 && this.g.d3) &&
              ((k = new Image()),
              (k.s = a),
              (k.g = this.g),
              (k.src = j[2]),
              (k.Zb = j),
              (k.Zb.x = f + d * 40),
              (k.Zb.y = g + e * 40 + this.da),
              (k.Zb.url = this.g.df),
              b == 1
                ? ((l = this.g.Zzs.zE(this.g.level.id)),
                  l.qds > 0
                    ? ((k.Zb.text =
                        "I%20just%20completed%20Level%20" +
                        this.g.level.iid +
                        "%20of%20Pathuku"),
                      (k.Zb.url +=
                        "/play/" +
                        this.g.level.id +
                        "/" +
                        this.g.level.id.charAt(2)))
                    : ((k.Zb.text =
                        "I'm%20stuck%20on%20Level%20" +
                        this.g.level.iid +
                        "%20of%20Pathuku.%20Try%20it."),
                      (k.Zb.url += "/play/" + this.g.level.id + "/00")))
                : (k.Zb.text = "Check%20out%20Pathuku. It's%20addictive!!!"),
              d++,
              d == 5 && ((d = 0), e++),
              (k.onload = function () {
                var a = this;
      ...
      UC: function (a) {
        var b,
          ...
          d,
          e = new Array();
        (e[e[pZ]] = new _Y4I(this.S.dc.dv, function () {
          this.g.KL(this.g.S.dl, "w");
        })),
          (e[e[pZ]] = new _Y4I("继续", function () {
            this.g.aJ.clear(), this.g.u7();
          })),
          (b = this),
          (c =
      ...
      d2: function (a, b) {
        ...
        b + 1 < this.S.kd[pZ] &&
          ((d[d[pZ]] = new _Y4I("Next", function () {
            this.g.aJ.clear(), this.g.d5(b + 1);
          })),
          (e.kV -= 45)),
          (d[d[pZ]] = new _Y4I("完成", function () {
            this.g.aJ.clear(), this.g.u7();
          })),
          ...
          this.zv(
            a,
            e,
            this.S.kd[b][1] + " (" + (b + 1) + "/" + this.S.kd[pZ] + ")",
            c,
            d
          );
      },
      ...
      pu: function (a, b) {
        ...
        (d[d[pZ]] = new _Y4I("下一关", e)),
          (d[d[pZ]] = new _Y4I(
            "Share Completed Level",
            function (a) {
              this.g.aJ.clear(), this.g.uZ(1, a);
            },
            e
          )),
          (d[d[pZ]] = new _Y4I("重新再玩", function () {
            this.g.sL(this.g.levels[this.g.UJ]), this.g.aJ.clear();
          })),
          b.KY > b.Zz
            ? this.zv(a, this.S.kH, "用时:" + b.Zz, "", d)
            : this.zv(a, this.S.kH, "完成", "点击右上角的分享按钮！", d),
          a.save(),
          (a.font = "10pt Arial"),
          (a[ZK] = "white"),
          (a.textAlign = "center"),
          ...
          b.newRecord
            ? a[ZH]("新纪录时间:" + b.Zz, this[W_] / 2, c)
            : a[ZH]("Time:" + b.Zz, this[W_] / 2, c),
          (a.shadowBlur = 8),
          this.O.uj(
            a,
            (this[W_] - this.S.kH.x) / 2 + 10,
            (this[w_] - this.S.kH.y) / 2 + 80 + this.da,
            this.S.kH.x - 20,
            40,
            15,
            b.qds
      ...
      zv: function (a, b, c, d, e) {
        ...
        (a[ZJ] = 2),
          ...
          f.addColorStop(0.4, this.S.dq),
          f.addColorStop(0.5, this.S.dq),
      ...
      Ub: function (a, b, c, d, e, f, g, h, i) {
        ...
        a.save(),
          (a[ZK] = this.S.kS.gL()),
          h
            ? ((a[Zk] = "rgb(255,255,255)"), (a[ZJ] = 4))
            : ((a[ZJ] = 2), (a[Zk] = this.S.kD.gL())),
          (j = a.createLinearGradient(0, c, 0, c + e)),
          j.addColorStop(0, this.S.d9),
          j.addColorStop(0.3, this.S.d0),
          j.addColorStop(0.4, this.S.dq),
    ...
    (uk[_] = {
      T: function (a, b) {
        ...
        (d.zj = d.zj + (a - b) * d.gb || 0),
          ...
          (c = d.u5.gL(0.04));
        while (d.zj - 1 > 0)
          d.pl(), d.zj--, (d.s[ZK] = c), d.s[Zd](0, 0, d[W_], d[w_]);
        d.s[ZF]();
      },
      Zv: function () {
    ...
    (Uc[_] = {
      ...
      zR: function (a) {
        var b = this;
        b.pl(
          new h(a * b.K + mr() * b.Y, 0),
          new h(a * b.K + mr() * b.Y, b[w_])
        );
      },
      zr: function (a) {
        var b = this;
        b.pl(
          new h(0, a * b.k + b.z8 + mr() * b.Y),
          new h(b[W_], a * b.k + b.z8 + mr() * b.Y)
        );
      },
      pl: function (a, b) {
    ...
    (u2[_] = {
      ...
      uv: function (a) {
        ...
        b.s[Zh](),
          b.Uq == 1
            ? ((b.s[ZK] = b.uw.gL(c)),
              b.s.arc(a.x, a.y, b.ua, 0, mP, a1),
              b.s.fill())
            : ((b.s[Zk] = b.uw.gL(c + 0.1)),
              (b.s[ZJ] = 1),
              b.s[UO](a.x, a.y),
              b.s[Zg](a.x2, a.y2),
              b.s[ZF]());
