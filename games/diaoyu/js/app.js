var HelloWorldLayer = cc.Layer.extend({
  ctor: function () {
    ...
    self.wxData = {
      appId: "", // 服务号可以填写appId
      imgUrl: "httpssssss://app.46465.com/html5/diaoyu/logo.png",
      link: "httpssssss://app.46465.com/html5/diaoyu/",
    ...
    WeixinApi.ready(function (Api) {
      ...
      var wxCallbacks = {
        ...
        confirm: function (resp) {
          ...
          //window.location.href='httpssssss://app.46465.com/';
          // alert("分享成功");
        },
        // 整个分享过程结束
        all: function (resp) {
          ...
          if (self.isGameOver) {
            if (window.location)
              window.location.href = "httpssssss://app.46465.com/html5/diaoyu/";
          }
        },
      };
  ...
  gameOver: function () {
    ...
    if (self.score <= 0) {
      self.wxData.desc =
        "蹲了" + self.hour + "个多小时，腿都麻了，我连半条鱼都木有调到";
    } else {
      self.wxData.desc =
        "经过" +
        self.hour +
    ...
    layerMask
      ...
      .then(function () {
        ...
        var share = cc.createSprite(
          "httpssssss://app.46465.com/html5/diaoyu/share.png",
          {
            anchor: [1.0, 1.0],
            xy: [720, 1280],
            opacity: 0,
  ...
  bornFish: function (n) {
    ...
    for (var i = 0; i < n; i++) {
      ...
      (function (fish) {
        ...
        fish
          .moveBy(860 / Math.abs(speedX), cc.p(flippedX == 180 ? 860 : -860, 0))
          .then(function () {
            clearInterval(fishTimer);
